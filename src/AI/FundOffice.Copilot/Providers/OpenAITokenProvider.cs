...
/// <summary>
/// OpenAI API 实现。也兼容所有 OpenAI 格式的第三方代理（如 OpenRouter、各种转发服务）。
///
/// API 端点：POST {_baseUrl}/v1/chat/completions
...
///
/// 工具调用流式格式：
///   data: {"choices":[{"delta":{"tool_calls":[{"index":0,"id":"call_123","function":{"name":"fn","arguments":""}}]}}]}
///   data: {"choices":[{"delta":{"tool_calls":[{"index":0,"function":{"arguments":"{\"lo"}}]}}]}
///   data: {"choices":[{"delta":{"tool_calls":[{"index":0,"function":{"arguments":"cation\":\"BJ\"}"}}]}}]}
///
/// 错误处理：
...
/// </summary>
public sealed class OpenAITokenProvider : TokenProviderBase
{
    ...
    public OpenAITokenProvider(OpenAIOptions options, HttpClient? httpClient = null)
    {
