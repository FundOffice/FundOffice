...
public partial class FundSharePairRule : VerifyRule, ITracker<IEnumerable<FundShareRecordByDaily>>, ITracker<IEnumerable<FundShareRecordByTransfer>>
{
    ...
    private partial void OnDataArrival(IEnumerable<FundShareRecordByDaily> obj) => FundIds.AddRange(obj.Select(x => x.FundId));

    private partial void OnDataArrival(IEnumerable<FundShareRecordByTransfer> obj) => FundIds.AddRange(obj.Select(x => x.FundId));
